...
RUN dpkg --add-architecture i386 && apt-get update && apt-get install wget iproute2 bzip2 bsdmainutils python-minimal tmux mailutils nullmailer curl file lib32gcc1 libstdc++6 libstdc++6:i386 -y
