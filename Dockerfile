...
RUN dpkg --add-architecture i386 && apt-get update && apt-get install bsdmainutils python tmux mailutils postfix curl file lib32gcc1 libstdc++6 libstdc++6:i386 -y
